...
test('DB Phase 49: Class 1500 gate valve rows are source-backed', () => {
  ...
  assert.equal(gate4.sourceRowNumber, 11);
...
test('DB Phase 49: valve exact lookup includes Class 1500 rows without fallback', () => {
  ...
  const miss = lookupComponentExact('gate valve 4 3000 rf', assets, { filters: { componentType: 'VALVE', valveType: 'GATE', nps: '4', classRating: '3000', facing: 'RF' } });
