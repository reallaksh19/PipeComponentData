...
const MODULE_ROOT = fileURLToPath(new URL('../pipetools/js/svg', import.meta.url));
...
test('new SVG modules respect the 200-line module limit', () => {
  const files = collectJsFiles(MODULE_ROOT).concat([fileURLToPath(new URL('../pipetools/js/svg.js', import.meta.url))]);
