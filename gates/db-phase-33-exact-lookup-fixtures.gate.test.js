...
const catalogs = {
  ...
  'data/normalized/flanges-expanded.json': JSON.parse(fs.readFileSync('data/normalized/flanges-expanded.json', 'utf8')),
  'data/normalized/valves.json': JSON.parse(fs.readFileSync('data/normalized/valves.json', 'utf8')),
  'data/normalized/valves-expanded.json': JSON.parse(fs.readFileSync('data/normalized/valves-expanded.json', 'utf8')),
