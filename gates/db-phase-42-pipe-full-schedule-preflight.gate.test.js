...
if (fs.existsSync('data/normalized/pipes-sch80-wave4.json')) {
  allRows.push(...readJson('data/normalized/pipes-sch80-wave4.json').rows);
}
if (fs.existsSync('data/normalized/pipes-expanded.json')) {
  allRows.push(...readJson('data/normalized/pipes-expanded.json').rows);
}
