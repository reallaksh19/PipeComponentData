...
test('DB Phase 59: exact lookup resolves wave 3 CL600 and rejects unpromoted CL9000', () => {
  ...
  const wrong = lookupComponentExact('FLG9000 10 BLIND', assets, { filters: { componentType: 'FLANGE', subtype: 'BLIND', nps: '10', classRating: '9000' } });
