...
test('DB Phase 56: exact lookup resolves CL600 and rejects unpromoted CL9000', () => {
  ...
  const wrong = lookupComponentExact('FLG9000 6 BLIND', assets, { filters: { componentType: 'FLANGE', subtype: 'BLIND', nps: '6', classRating: '9000' } });
