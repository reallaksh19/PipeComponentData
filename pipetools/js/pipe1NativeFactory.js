export const PIPE1_NATIVE_FACTORY_VERSION = 'pipe1-native-slot-contract-v14-label-end-baseline-aligned';
...
export function buildPipe1NativeDrawing(doc = document) {
  ...
  labelText(labels, 6600, 13255, 'OD', 110, { 'text-anchor': 'end' });
  labelText(labels, 6685, 15772, 'ID', 110, { 'text-anchor': 'end' });
  ...
  slotText(slots, 7292.5, 13255, '-', 110, 'OD');
  slotText(slots, 7295, 15772, '-', 110, 'ID');
